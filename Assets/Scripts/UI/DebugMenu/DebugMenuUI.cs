...
#region Internal
    ...
    private static Vector2 WINDOW_DIMENSION = new Vector2(256.0f, 220.0f);
        ...
        { // Main Window Area
            ...
            GUILayout.BeginVertical();
            {
                ...
                GUILayout.BeginHorizontal();
                {
                    ...
                    masterVolume = GUILayout.HorizontalSlider(masterVolume, -80.0f, 20.0f,
                        GUILayout.ExpandWidth(true));
                    ...
                    if (GUILayout.Button(masterMuted ? "M" : "U", GUILayout.Width(30f)))
                    {
